...
{"lineNum":"    8","line":""},
{"lineNum":"    9","line":"if [ $# -eq 0 ]; then","class":"lineNoCov","hits":"0",},
{"lineNum":"   10","line":"  echo >&2 \"Usage: perf <ip>\"","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   43","line":"  ip=\"$1\"","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   46","line":"  format=\'def bytes:","class":"lineNoCov","hits":"0",},
{"lineNum":"   47","line":"  def _bytes(v; u):","class":"lineNoCov","hits":"0",},
{"lineNum":"   48","line":"    if (u | length) == 1 or (u[0] == \"\" and v < 10000) or v < 1000 then","class":"lineNoCov","hits":"0",},
{"lineNum":"   49","line":"      \"\\(v *100 | round /100) \\(u[0])B\"","class":"lineNoCov","hits":"0",},
{"lineNum":"   50","line":"    else"},
{"lineNum":"   51","line":"      _bytes(v/1000; u[1:])","class":"lineNoCov","hits":"0",},
{"lineNum":"   52","line":"    end;","class":"lineNoCov","hits":"0",},
{"lineNum":"   53","line":"  _bytes(.; \":k:M:G:T:P:E:Z:Y\" / \":\");","class":"lineNoCov","hits":"0",},
{"lineNum":"   54","line":"  select(.event==\"interval\") | .data.sum.bits_per_second | \"\\(bytes)/s\"\'","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   57","line":"  iperf3 --client=\"$ip\" --json-stream \"$@\" |","class":"lineNoCov","hits":"0",},
{"lineNum":"   58","line":"    jq --compact-output --raw-output --unbuffered \"$format\"","class":"lineNoCov","hits":"0",},
{"lineNum":"   59","line":"  # sed -e \'s# .B/s##g\'"},
{"lineNum":"   60","line":"}"},
{"lineNum":"   61","line":""},
{"lineNum":"   62","line":"main() {"},
{"lineNum":"   63","line":"  if [ $# -le 1 ]; then","class":"lineNoCov","hits":"0",},
{"lineNum":"   64","line":"    set -- \"$@\" --time=33","class":"lineNoCov","hits":"0",},
{"lineNum":"   65","line":"  fi"},
...
{"lineNum":"   69","line":"  if [ -t 1 ]; then","class":"lineNoCov","hits":"0",},
{"lineNum":"   70","line":"    run_iperf3 \"$@\" | npx cli-plot # -w 100 -h 10","class":"lineNoCov","hits":"0",},
{"lineNum":"   71","line":"  else"},
{"lineNum":"   72","line":"    run_iperf3 \"$@\"","class":"lineNoCov","hits":"0",},
{"lineNum":"   73","line":"  fi"},
{"lineNum":"   74","line":"}"},
{"lineNum":"   75","line":""},
{"lineNum":"   76","line":"main \"$@\"","class":"lineNoCov","hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "", "date" : "2026-03-02 14:10:12", "instrumented" : 23, "covered" : 0,};
var merged_data = [];

...
{"lineNum":"    5","line":"  if ! command -v usage >/dev/null; then","class":"lineCov","hits":"1","order":"395","possible_hits":"0",},
...
{"lineNum":"    9","line":"  fi"},
{"lineNum":"   10","line":"  usage exec --help bash \"$0\"","class":"lineCov","hits":"1","order":"396","possible_hits":"0",},
{"lineNum":"   11","line":"}"},
{"lineNum":"   12","line":""},
{"lineNum":"   13","line":"# Print #USAGE directives without the leading prefix"},
{"lineNum":"   14","line":"usage_spec() {"},
{"lineNum":"   15","line":"  grep \'^#USAGE\' \"$0\" | sed \'s/^#USAGE //\'","class":"lineCov","hits":"2","order":"399","possible_hits":"0",},
{"lineNum":"   16","line":"}"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "test", "date" : "2026-06-08 18:59:40", "instrumented" : 6, "covered" : 3,};
var merged_data = [];

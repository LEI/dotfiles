# User completions generated from #USAGE directives
...
# Selection mode on second tab, first tab shows list
zstyle ':completion:*' menu select

# Shift-Tab cycles backward; alternative: zsh/terminfo $terminfo[kcbt]
